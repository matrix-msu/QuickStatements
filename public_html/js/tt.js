...
//					url += '#random=' + Math.random() + '.' + n ;
	...
	this.addILdropdown = function ( target ) {
		...
		function addDropdown () {
			...
			h += "</select>" ;
			// h += "&nbsp;<a href='https://tools.wmflabs.org/tooltranslate/#tool="+me.toolinfo.meta.id+"' target='_blank' style='text-decoration:none;font-size:2rem;vertical-align:middle;'>&#x1f30d;</a>" ;
			h += "</form>" ;
			$(target).html ( h ) ;
